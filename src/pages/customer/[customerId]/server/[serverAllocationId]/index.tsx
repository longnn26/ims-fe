...
const Customer: React.FC = () => {
  ...
  }, [session, paramGet, rUIpAddressParamGet, router.query.serverAllocationId]);

  return (
    <AntdLayoutNoSSR
      content={
        <>
          {router.query.customerId !== serverAllocationDetail?.customerId ||
          serverAllocationDetail === undefined ? (
            <ModalEmpty />
          ) : (
            <>
