...
import { Form, Input, Space, message, Button, Layout, Spin, Alert, Modal } from "antd";
    ...
    return (
        <>
            <Layout className="h-screen">
                <Header className="h-auto flex justify-center" style={{ background: "white" }}>
                                                ...
                                                validator: async (_, value) => {
                                                    if (value) {
                                                        if (value === form.getFieldValue('currentPass')) {
                                                            return Promise.reject(new Error('The password must be different to the current password!'));
                                                        } else if (value === "Password@123")
                                                            return Promise.reject(new Error('The password must be different to the default password!'));
                                                    }
