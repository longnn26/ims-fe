  ...
  const ModalCreate: React.FC<Props> = (props) => {
    ...
    useEffect(() => {
      ...
      if (selectedServer) {
        if (selectedReason === "Upgrade") {getMoreRequestUpgrade(selectedServer?.id!, 0, []);}
        ...
        >
          <div className="flex max-w-md flex-col gap-4 m-auto">
            ...
            >
              ...
              {Boolean((selectedReason === "Install" || selectedReason === "Uninstall") && selectedServer !== undefined && requestExpand !== undefined) && (
                <>
                  <Form.Item
